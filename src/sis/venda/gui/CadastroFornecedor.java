...
import sis.venda.dao.FornecedorDAO;
import sis.venda.gui.tm.FornecedorTableModel;
...
public class CadastroFornecedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(pnBarraFerramentas, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 389, -1));
        ...
        pnConteudo.add(pnForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 369, -1));
        ...
        pnConteudo.add(spGrade, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 81, 369, 274));

        getContentPane().add(pnConteudo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 55, 389, 365));
    ...
    private void ftfCnpjKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ftfCnpjKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ftfCnpj.getFocusLostBehavior();
        }
    }//GEN-LAST:event_ftfCnpjKeyPressed
