...
import sis.venda.gui.tm.ProdutoTableModel;
...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void ftfPrecoVendaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ftfPrecoVendaKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ftfPrecoVenda.getFocusLostBehavior();
        }
    }//GEN-LAST:event_ftfPrecoVendaKeyPressed
